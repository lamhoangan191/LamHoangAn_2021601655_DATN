    ...
    <?php while ($pet = $result->fetch_assoc()): ?>
      <div class="col-md-3 mb-4">
        <div class="card-pet card h-100 bg-light border-2 border-dark">
            ...
            // Tạo link đến chitietthucung_kh.php với đủ tham số
            $link = "chitietthucung_kh.php?" . http_build_query($query_params);
            ?>
          ...
          <div class="card-body">
            <h5 class="card-title">
              <a href="<?= $link ?>" class="text-decoration-none fw-bold"><?php echo $pet['tentc']; ?></a>
            </h5>
            <hr>
